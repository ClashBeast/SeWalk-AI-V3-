...
// =============================================
const systemPrompts = {
  home:      "You are SeWalk AI — a smart, friendly, and versatile AI assistant. You help with anything the user asks: answering questions, writing, coding, analysis, advice, brainstorming, and more. Be concise, clear, and warm. Adapt your tone to the conversation.",
...
async function sendMsg() {
  ...
  if (!currentUser) {
    ...
    if (guestMsgCount === GUEST_MSG_LIMIT - 1) {
      showToast(`⚠️ Last free message — sign in to keep chatting!`);
    }
    guestMsgCount++;
    // Update badge
    const guestBadge = document.getElementById('guestCounterBadge');
